package com.zthreex.vmplayer.player;
...
public class VlcMediaPlayer extends AbsMediaPlayer {
	...
	/* */
	private int mTime = -1;
	private static  Boolean bIsOpenFaild = false;
	...
	protected native static int  nativeIsTotallyRemoved();
	...
	/*added by zx
	 * Other process can acquire the status of player
	 * */
	public static Boolean IsTotallyRemoved(){
		int nIsTotallyRemoved = nativeIsTotallyRemoved();
		if(nIsTotallyRemoved==1) return true;
		else return false;
	}
	
	public static Boolean IsOpenFailed(){
		Log.d("vmplayer", "func called");
		return bIsOpenFaild;
	}
